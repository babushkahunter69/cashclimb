    ...
    <div className="w-full max-w-sm">
      ...
      <div className="bg-bg-2 border border-border rounded-2xl p-8">
        ...
        <p className="text-[#9A9490] text-sm mb-6">
          Enter your password to manage CashClimb.
        </p>
...
function LoginFallback() {
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="bg-bg-2 border border-border rounded-2xl p-8 animate-pulse">
        <div className="h-7 bg-bg-3 rounded w-40 mb-2" />
        <div className="h-4 bg-bg-3 rounded w-56 mb-6" />
        <div className="h-10 bg-bg-3 rounded mb-4" />
...
// Main page — wraps LoginForm in Suspense as required by Next.js 14
